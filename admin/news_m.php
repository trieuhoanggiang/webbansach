...
<?php if ($image!=''){ echo '<img border="0" src="../'.$image.'" width="100"><br><br>Hình ảnh';}?>								</td>	<!--<td width="40%" align="center" class="smallfont">
...
<?php if ($image_large!=''){ echo '<img border="0" src="../'.$image_large.'" width="100"><br><br>Hình lớn';}?>								</td>-->
				...
				<tr>
					...
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont">
						<?php echo comboCategory('ddCat',getArrayNews($tableCategoryConfig),'smallfont',$parent,0)?>					</td>
				...
				<tr>
					...
					<td width="83%" class="smallfont">
						<input value="<?php echo $sort?>" type="text" name="txtSort" class="textbox" size="12">					</td>
